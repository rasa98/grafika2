...
public class Cylinder extends Scene.Base {
...
//				Body.uniform(Cylinder.crh(Vec3.xyz( 0, -0.5, 0.7), 0.3, 0.5).transformed(Affine.rotationAboutX(-0.1)), Material.mirror())
				Body.uniform(xyz.marsavic.gfxlab.graphics3d.solids.Cylinder.crh(Vec3.xyz( -0.1, -0.6, -0.5), 0.7, 0.002).transformed(Affine.rotationAboutZ(-0.05)), Material.LIGHT)
		);
	}
